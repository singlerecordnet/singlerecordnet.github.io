...
[Résume](indice.html)
## Summary
Software and data engineer with 17 years of experience in database design & maintenance, data analytics & visualizations and fullstack web development. Proven ability to conduct self-guided research in order to lead team efforts that create new business opportunities and improve operational processes.
...
- obtained 2nd Place 2025 Claro Employee Innovation Awards (Claro Awards): EBLAST Manager Team Lead - built custom tool for designing, documenting and approving mass email campaigns,
- improved Analytics Impact Visibility: While functioning as the technical mass email marketing (EBLAST) administrator, built a self-hosted URL shortening service in order to supplement the functionality of the in-house email provider with real time updates on campaign KPIs,
- adopted and improved internal reporting self-service tool: Implemented composability for all reports where users can pick and choose their desired columns. Designed and maintain daily 'hot tables' pipeline in order to reduce request processing time. Impact: Available reports increased from 15 reports used by 7 users, to 45 reports used by 25 users across 5 departments. New report development time decreased from 10 days to 2 days. 
- improved Reporting Request and Delivery Solution solution diversity: Designed, tested, built and standardized report automation and distribution pipeline with self-refreshing dashboards, report request owner administered distribution lists and email notifications. Added validation step to report request pipeline. Impact: 25 reports have been fully automated which support daily operations within 5 departments comprised of at least 700 personnel, including external sales partners.
...
-	maintained and organized documentation of collected data for presentations to ,
